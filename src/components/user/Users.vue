    ...
    <el-card class="box-card">
      ...
      <el-table :data="userlist" stripe border>
        ...
        <el-table-column label="状态">
          <!--
          作用域插槽
          slot-scope 用来得到子组件传递过来的数据
          -->
          <template slot-scope="scope">
            <!--获取整个对象中的属性 {{scope.row}} -->
